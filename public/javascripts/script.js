...
const allElementsNamesMainPeriodicTableNonSplit = ["hydrogen", "helium", "lithium", "beryllium", "boron", "carbon", "nitrogen", "oxygen", "fluorine", "neon", "sodium", "magnesium", "aluminium", "silicon", "phosphorus", "sulfur", "chlorine", "argon", "potassium", "calcium", "scandium", "titanium", "vanadium", "chromium", "manganese", "iron", "cobalt", "nickel", "copper", "zinc", "gallium", "germanium", "arsenic", "selenium", "bromine", "krypton", "rubidium", "strontium", "yttrium", "zirconium", "niobium", "molybdenum", "technetium", "ruthenium", "rhodium", "palladium", "silver", "cadmium", "indium", "tin", "antimony", "tellurium", "iodine", "xenon", "cesium", "barium", "hafnium", "tantalum", "tungsten", "rhenium", "osmium", "iridium", "platinum", "gold", "mercury", "thallium", "lead", "bismuth", "polonium", "astatine", "radon", "francium", "radium", "rutherfordium", "dubnium", "seaborgium", "bohrium", "hassium", "meitnerium", "darmstadtium", "roentgenium", "copernicium", "nihonium", "flerovium", "moscovium", "livermorium", "tennessine", "oganesson"];

var elementCells = document.getElementsByClassName("elementTD");

for (let index = 0; index < elementCells.length; index++) {
    var value = elementCells[index];
    console.log();
    value.innerHTML = `
          <div>
              <p class="ElementSymbol">${
                allDataElements[allElementsNamesMainPeriodicTableNonSplit[index]]["symbol"]
              }</p>
              <p class="smallTextElementName">${
                allElementsNamesMainPeriodicTableNonSplit[index]
              }</p>
              <p class="atomicNumber">${
                allDataElements[allElementsNamesMainPeriodicTableNonSplit[index]][
                  "number"
                ]
              }</p>
          </div>
...
var elementCellsSplitTable = document.getElementsByClassName("splitPeriodicTableElementCell");
const elementNameSplitTable = ["lanthanum", "cerium", "praseodymium", "neodymium", "promethium", "samarium", "europium", "gadolinium", "terbium", "dysprosium", "holmium", "erbium", "thulium", "ytterbium", "lutetium", "actinium", "thorium", "protactinium", "uranium", "neptunium", "plutonium", "americium", "curium", "berkelium", "californium", "einsteinium", "fermium", "mendelevium", "nobelium", "lawrencium"];
for (let index = 0; index < elementCellsSplitTable.length; index++) {
    var value = elementCellsSplitTable[index];
    value.innerHTML = `
          <div>
              <p class="ElementSymbol">${
                allDataElements[elementNameSplitTable[index]]["symbol"]
              }</p>
              <p class="smallTextElementName">${elementNameSplitTable[index]}</p>
              <p class="atomicNumber">${
                allDataElements[elementNameSplitTable[index]]["number"]
              }</p>
          </div>
      `;
}